...
def model_fn(features, labels, mode, params):
  ...
  conv1 = Conv2D(32, (5, 5), activation="relu",
                 input_shape=(28, 28, 1))(features["x"])
...
train_input_fn = numpy_io.numpy_input_fn(x_train_dict, y_train,
                                         batch_size=BATCH_SIZE,
                                         shuffle=True, num_epochs=None,
                                         queue_capacity=100000, num_threads=4)

x_test_dict = {"x": x_test}
test_input_fn = numpy_io.numpy_input_fn(x_test_dict, y_test,
...
learn_runner.run(
    ...
    run_config=tf.contrib.learn.RunConfig(model_dir="/tmp/experiment"))
