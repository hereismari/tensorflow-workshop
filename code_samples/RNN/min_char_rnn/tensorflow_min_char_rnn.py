...
# Loss
loss = tf.reduce_sum(tf.nn.softmax_cross_entropy_with_logits(labels=targets, logits=outputs))

# Minimizer
minimizer = tf.train.AdagradOptimizer(learning_rate=LEARNING_RATE, use_locking=True)
